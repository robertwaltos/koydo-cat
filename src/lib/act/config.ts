// Auto-generated shim — re-exports from @/lib/cat/config
// This lets shared ecosystem components import from "@/lib/act/config"
import type { ExamConfig as _cat_Config } from "@/lib/cat/config";
import { EXAM_CONFIG as _raw } from "@/lib/cat/config";
