...
export const metadata: Metadata = {
  title: "Pricing — Cat Premium",
  description: "Unlock unlimited Cat practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=cat&cadence=annual`;
